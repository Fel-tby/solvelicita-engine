...
SNAPSHOT_SCHEMA_SPEC = [
    ...
    ("score_base_pre_icf", "FLOAT64", "NULLABLE"),
    ...
    ("icf_fator_medio", "FLOAT64", "NULLABLE"),
    ("eorcam_icf_fator", "FLOAT64", "NULLABLE"),
    ("lliq_icf_fator", "FLOAT64", "NULLABLE"),
    ("rproc_icf_fator", "FLOAT64", "NULLABLE"),
    ("autonomia_icf_fator", "FLOAT64", "NULLABLE"),
    ("lliq_icf_exercicio", "INT64", "NULLABLE"),
    ("lliq_icf_status", "STRING", "NULLABLE"),
    ("lliq_icf_conceito", "STRING", "NULLABLE"),
    ("eorcam_icf_previo", "BOOL", "NULLABLE"),
    ("eorcam_icf_defasado", "BOOL", "NULLABLE"),
    ("eorcam_icf_sem_registro", "BOOL", "NULLABLE"),
    ("lliq_icf_previo", "BOOL", "NULLABLE"),
    ("lliq_icf_defasado", "BOOL", "NULLABLE"),
    ("lliq_icf_sem_registro", "BOOL", "NULLABLE"),
    ("rproc_icf_previo", "BOOL", "NULLABLE"),
    ("rproc_icf_defasado", "BOOL", "NULLABLE"),
    ("rproc_icf_sem_registro", "BOOL", "NULLABLE"),
    ("autonomia_icf_previo", "BOOL", "NULLABLE"),
    ("autonomia_icf_defasado", "BOOL", "NULLABLE"),
    ("autonomia_icf_sem_registro", "BOOL", "NULLABLE"),
    ...
    ("contrib_eorcam_base", "FLOAT64", "NULLABLE"),
    ("contrib_lliq_base", "FLOAT64", "NULLABLE"),
    ("contrib_autonomia_base", "FLOAT64", "NULLABLE"),
    ("contrib_rproc_base", "FLOAT64", "NULLABLE"),
